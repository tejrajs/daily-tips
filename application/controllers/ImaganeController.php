...
class ImaganeController extends Controller{
	...
	{
		$test = "<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. \n Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</p>";
		$image  = new GDI_image($test);
		
		$image->font_size = '50';
		$image->save_to_file = false;
		//$image->file_name= BASE_PATH .'/images/'.time();
		$image->font_color = '#000000';
		$image->font_name = 'font/Chocolate Bar Demo.otf';
		$image = $image->save();
